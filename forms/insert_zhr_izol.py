...
def insert_zhr_izol(def_db,road_programm,road_db,tube,km_start,km_finish,dy_tube):
    ...
    for remont in def_db:
        ...
        ws_l1['V' + str(current_row)] = 'Мастер РУ №2 ЦРС "Рязань"\n\n_____________\nЛазарев А.В.'
    ...
    ws_l1['X'+str(current_row+2)]='%s %s %s _____________ %s г.'%(remont['otv'][1],remont['otv'][2],remont['otv'][0],remont['date'][2].strftime('%d.%m.%Y'))
